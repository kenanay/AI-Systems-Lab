...
4. Frontend'i backend hazır olduktan sonra yeniden başlatın.
...
Browser cookie'lerinin silinmediğini, backend/frontend portlarının aynı varsayımı kullandığını ve `/api/v1/auth/refresh` isteğinin cookie ile gönderildiğini kontrol edin.
